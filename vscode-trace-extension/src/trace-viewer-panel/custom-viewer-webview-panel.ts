...
export class CustomViewerPanel {
    private static readonly viewType = 'trace.viewer.customviewer';
    ...
    private static _getHtmlForWebview(webview: vscode.Webview, extensionUri: vscode.Uri): string {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(extensionUri, 'pack', 'customViewerPanel.js'));
        ...
        return `<!DOCTYPE html>
			...
			<head>
				...
				<meta http-equiv="Content-Security-Policy"
					...
					connect-src ${getTraceServerUrl(ClientType.BACKEND)} ${getTraceServerUrl(ClientType.FRONTEND)} https://github.com;
