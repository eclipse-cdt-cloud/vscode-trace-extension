...
class TimeRangeDataWidget extends React.Component {
    ...
    private _onVscodeRestoreView = (data: any): void => {
        if (data) {
            const { mapArray, activeData } = JSONBigUtils.parse<{mapArray: Array<ExperimentTimeRangeData>, activeData: ExperimentTimeRangeData}>(data);
            // TODO add schema because ExperimentTimeRangeData include bigints
